...
<head>
  ...
  <title>Safario Travel - Home</title>
	<link rel="icon" href="/landing/img/Fevicon.png" type="image/png">
  ...
  <link rel="stylesheet" href="/landing/vendors/linericon/style.css">
  ...
  <link rel="stylesheet" href="/landing/vendors/flat-icon/font/flaticon.css">
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          <a class="navbar-brand logo_h" href="index.html"><img src="/landing/img/logo.png" alt=""></a>
    ...
    <div class="container">
      ...
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class="col-md-6 col-lg-7 col-xl-6 offset-xl-1">
          <img class="img-fluid" src="/landing/img/home/hero-img.png" alt="">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-margin generic-margin">
    <div class="container">
      <div class="section-intro text-center pb-90px">
        <img class="section-intro-img" src="/landing/img/home/section-icon.png" alt="">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img class="img-fluid" src="/landing/img/home/service1.png" alt="">
            </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img class="img-fluid" src="/landing/img/home/service2.png" alt="">
            </div>
            <div class="service-card-body">
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img class="img-fluid" src="/landing/img/home/service3.png" alt="">
            </div>
            <div class="service-card-body">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7 col-md-6 mb-4 mb-md-0">
          <div class="about-img">
            <img class="img-fluid" src="/landing/img/home/about-img.png" alt="">
          </div>
        </div>
  ...
  <section class="section-margin pb-xl-5">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="tour-card">
            <img class="card-img rounded-0" src="/landing/img/home/tour1.png" alt="">
        ...
        <div class="col-md-6">
          ...
          <div class="tour-card">
            <img class="card-img rounded-0" src="/landing/img/home/tour2.png" alt="">
            <div class="tour-card-overlay">
              <div class="media">
                <div class="media-body">
                  <h4>Paris tour offer</h4>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-7">
          <div class="tour-card">
            <img class="card-img rounded-0" src="/landing/img/home/tour3.png" alt="">
            <div class="tour-card-overlay">
              <div class="media">
                <div class="media-body">
                  <h4>Paris tour offer</h4>
        ...
        <div class="col-md-6 col-lg-5">
          <div class="tour-card">
            <img class="card-img rounded-0" src="/landing/img/home/tour4.png" alt="">
            <div class="tour-card-overlay">
              <div class="media">
                <div class="media-body">
                  <h4>Paris tour offer</h4>
          ...
          <div class="row">
            <div class="col-md-3 col-lg-2 align-self-center">
              <div class="testimonial__img">
                <img class="card-img rounded-0" src="/landing/img/testimonial/t-slider1.png" alt="">
              </div>
            </div>
  ...
  <section class="section-padding bg-gray">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="/landing/img/blog/blog-1.png" alt="">
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="/landing/img/blog/blog-2.png" alt="">
            <div class="card-blog-body">
              <a href="#">
                <h4>Forest responds to consultation smoking in al fresco.</h4>
              </a>
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="/landing/img/blog/blog-3.png" alt="">
            <div class="card-blog-body">
              <a href="#">
                <h4>Forest responds to consultation smoking in al fresco.</h4>
              </a>
        ...
        <div class="col-lg-3  col-md-6 col-sm-6">
          <div class="single-footer-widget mail-chimp">
            ...
            <ul class="instafeed d-flex flex-wrap">
              <li><img src="/landing/img/instagram/i1.jpg" alt=""></li>
              <li><img src="/landing/img/instagram/i2.jpg" alt=""></li>
              <li><img src="/landing/img/instagram/i3.jpg" alt=""></li>
              <li><img src="/landing/img/instagram/i4.jpg" alt=""></li>
              <li><img src="/landing/img/instagram/i5.jpg" alt=""></li>
              <li><img src="/landing/img/instagram/i6.jpg" alt=""></li>
              <li><img src="/landing/img/instagram/i7.jpg" alt=""></li>
              <li><img src="/landing/img/instagram/i8.jpg" alt=""></li>
            </ul>
          </div>
        </div>						
      </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  <script src="/landing/js/skrollr.min.js"></script>
